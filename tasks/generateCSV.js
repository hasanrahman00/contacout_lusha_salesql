...
const COLUMNS = [
    ...
    { label: 'Website',              key: 'salesqlOrgWebsite' },
    { label: 'Website_one',          key: 'emailDomain' },
    { label: 'Website_two',          key: 'salesqlEmail' },
    ...
    { label: 'Employees Range',      key: 'salesqlOrgEmployees' },
    ...
    { label: 'Founded Year',         key: 'salesqlOrgFounded' },
];
